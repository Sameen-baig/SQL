...
select LastName From Employees where Employees.department = Departments.Code;
select distinct LastName from Employees;
-- 2.3 Select all the data of employees whose last name is "Smith".
select LastName='Smith' From Employees;
select LastName From Employees where LastName ='Smith';
-- 2.4 Select all the data of employees whose last name is "Smith" or "Doe".
SELECT * FROM Employees WHERE LastName IN ('Smith' , 'Doe');
select LastName From Employees where LastName ='Smith' or LastName = 'Doe'
...
select e.Name, e.LastName from Employees e Join Departments d ON e.Department = d.Code AND d.Budget > 60000;
