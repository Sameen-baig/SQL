...
Create Table AssignedTo(
	...
	Primary Key(Scientists, Project),
	Foreign Key(Scientists) references Scientist (SSN),
...
INSERT INTO Scientist(SSN,Name) 
...
INSERT INTO AssignedTo ( Scientists, Project)
...
Select s.Name, p.Name, p.Hours from Scientist s 
inner join AssignedTo a ON s.SSN=a.Scientists
